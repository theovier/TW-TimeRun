...
MACRO_CONFIG_INT(SvGameOverDelay, sv_gameover_delay, 3, 0, 10, CFGFLAG_SERVER, "How many seconds the server waits to restart the round after the death of the boss")
...
MACRO_CONFIG_INT(SvPickupHealthGain, sv_pickup_health_gain, 3, 1, 10, CFGFLAG_SERVER, "The amount of lives you gain by picking up a heart")
