...
void CCharacter::DoWeaponSwitch()
{
	...
	if(m_ReloadTimer != 0 || m_QueuedWeapon == -1 || m_aWeapons[WEAPON_NINJA].m_Got || m_Reloading)
		return;
	...
	switch(m_ActiveWeapon)
	{
		case WEAPON_HAMMER:
		{
			...
			if(!m_pPlayer->IsBot())
			{
				...
				{
					CTurret *t = ((CGameControllerTimeRun*)GameServer()->m_pController)->m_Turrets[b];
					if (!t || !t->IsAlive())
						continue;
